...
const mapTwoToThe = (arr) => arr.map(e => Math.pow(2,e));
...
const charCode = (arr) => arr.map(e => e.charCodeAt(0));
...
const evenOdd = (arr) => arr.map(e => e % 2 === 0 ? 'even': e % 2 > 0 ? 'odd' : 'N/A');
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
...
const extractAbilities = (arr) => arr.map(e => e.ability.name);
/* ------------------------------------------------------------------------------------------------
CHALLENGE 7
...
const extractStats = (arr) => arr.map(e => ({name: e.stat.name, total: e.effort + e.baseStat}));
